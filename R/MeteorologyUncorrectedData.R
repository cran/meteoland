MeteorologyUncorrectedData<-function(points, reference_data, projection_data, dates,
  ...
  if(!inherits(reference_data,"data.frame") && !inherits(reference_data,"list")) stop("'reference_data' has to be of class 'data.frame' or 'list'.")
  if(!inherits(projection_data,"data.frame") && !inherits(projection_data,"list")) stop("'projection_data' has to be of class 'data.frame' or 'list'.")
